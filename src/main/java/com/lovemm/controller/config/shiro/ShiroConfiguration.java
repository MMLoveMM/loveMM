...
import com.lovemm.vo.CacheType;
...
public class ShiroConfiguration {
	...
	public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
		...
		outFilter.setRedirectUrl("/test/login");
		logoutFilter.put("/test/logout", outFilter);
		shiroFilterFactoryBean.setFilters(logoutFilter);
		// 设置login页面，默认/login.jsp
		shiroFilterFactoryBean.setLoginUrl("/test/toLogin");
		// 设置登录成功后跳转链接
		shiroFilterFactoryBean.setSuccessUrl("/test/toIndex");
		// 设置未授权页面
